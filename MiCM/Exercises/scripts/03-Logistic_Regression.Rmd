...
#if a value is less than 0.5, we force to 0 and otherwise 1.
num_pred = ifelse(mini_iris$Num_pred<=0.5,0,1)
accuracy = length(which(mini_iris$Num_Species == num_pred))/length(num_pred)
accuracy
```
